...
ProjectPath            :=C:/Users/PC/Desktop/DSA/Stack/Stack_using_array
...
../build-$(ConfigurationName)/Stack_using_array/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/Stack_using_array/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/PC/Desktop/DSA/Stack/Stack_using_array/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
