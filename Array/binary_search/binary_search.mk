...
ProjectPath            :=C:/Users/PC/Desktop/DSA/Array/binary_search
...
../build-$(ConfigurationName)/binary_search/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/binary_search/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/PC/Desktop/DSA/Array/binary_search/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
